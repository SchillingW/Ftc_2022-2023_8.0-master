...
*/
        ...
        //linearSlide.goToFull(linearSlide.med, telemetry, this);
        robot.reachPoint(new Pose2d(robot.xDim.toCell(1), robot.yDim.toCell(4), new Rotation2d(90)), telemetry, this);
        ...
        robot.reachPoint(new Pose2d(robot.xDim.toCell(2), robot.yDim.toCell(5) - 4.5, new Rotation2d()), telemetry, this);
        ...
        //High Junction
        linearSlide.goToFull(linearSlide.high, telemetry, this);
        robot.reachPoint(new Pose2d(robot.xDim.toPole(2), robot.yDim.toPole(3), new Rotation2d()), telemetry, this);
        sleep(200);
        if(opModeIsActive()) linearSlide.openClaw();
        linearSlide.goToFull(linearSlide.low, telemetry, this);
        robot.reachPoint(new Pose2d(robot.xDim.toCell(2), robot.yDim.toPole(5), new Rotation2d()), telemetry, this);
        ...
        {
            linearSlide.goToFull(linearSlide.med, telemetry, this);
            robot.reachPoint(new Pose2d(robot.xDim.toPole(1), robot.yDim.toPole(4), new Rotation2d()), telemetry, this);
            sleep(200);
    ...
    public void GrabConeFromCell(int i)
    {
        ...
        robot.TranslateY(-0.15, 0.2, telemetry, this);
