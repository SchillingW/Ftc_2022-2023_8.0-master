...
@Autonomous(name="AUTO_RIGHT", group="PursuitBot")
public class AUTO_RIGHT extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        med = new Pose2d(robot.xDim.toCell(2) - poleCellDiff + 2.25, robot.yDim.toPole(3) - 2, Rotation2d.fromDegrees(185));
        ...
        robot.reachPointSlideNextPoint(new Pose2d(robot.xDim.toCell(0), robot.yDim.toCell(4), new Rotation2d()), new Pose2d(robot.xDim.toCell(2), robot.yDim.toCell(4), new Rotation2d()), telemetry, this, linearSlide, linearSlide.driveHeight, false);
        robot.setConstants(0.8, 0.25, 16, 4);
        ...
        ////robot.reachPointSlideNextPoint(beforeRot, med, telemetry, this, linearSlide, linearSlide.low, false);
    ...
    {
        Pose2d newMed = new Pose2d(med.getX() + 0.825 * (i + 1), med.getY(), med.getRotation());
