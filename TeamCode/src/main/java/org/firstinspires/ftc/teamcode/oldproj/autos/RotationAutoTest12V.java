...
@Autonomous(name="RotationAutoTest12V", group="PursuitBot")
public class RotationAutoTest12V extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        high = new Pose2d(robot.xDim.toCell(2) + 2.5, robot.yDim.toPole(3) - 1.5, new Rotation2d());
    ...
    public void Cycle(int i, boolean lastCycle, int result)
    {
        ...
        robot.setConstants(0.69, 0.25, 16, 6);
